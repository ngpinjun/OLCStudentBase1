...
print(f"The fastest time is {fasttime} . The postion of the swimmer is {fastindex + 1}.")
print(f"The slowest time is {slowtime} . The postion of the swimmer is {slowindex + 1} .")
...
print(f"The class with the highest amount is {highclass} with ${highamt}")
print(f"The class  with the lowest amount is {highclass} with ${highamt}")
